...
"""Termination helpers for the stack_cup task.
...
# Module-level constant: EXPECTED stacked z-gap between consecutive layers.
# For cup geometry this is the EMPIRICAL nested-stack spacing (≠ cup
# geometric height), measured at 0.077 m for the 9 cm scaled cup.
# Must stay in sync with `CUBE_SIZE` in observations.py, rewards.py,
# and config/franka/joint_pos_env_cfg.py.
CUBE_SIZE = 0.077
...
def _no_contact_between_cube_and_gripper_or_ee(
    ...
    declared on each contact sensor in StackCupSceneCfg.
    """
